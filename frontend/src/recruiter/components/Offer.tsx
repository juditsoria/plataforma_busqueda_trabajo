    ...
    <article className='relative bg-secondary rounded-xl flex justify-between items-center pl-5 pr-20 pt-10 pb-[72px] gap-5 cursor-pointer hover:bg-secondary/70 transition-all duration-300 group'>
      <div className='flex items-center justify-start gap-5 w-full'>
        ...
        <div className='flex flex-col justify-between items-start w-full'>
          ...
          <span className='text-ellipsis text-left overflow-hidden whitespace-nowrap w-[370px] -mt-1'>ACTUANDO SAS</span>
      ...
      <div className='flex items-end justify-end w-3/6 h-full'>
        <span className='text-right line-clamp-3 text-gray-600'>Término fijo Salario a convenir, 4 años de experiencia, Profesional, Especialización/ Maestría, Doctorado.Término fijo Salario a convenir, 4 años de experiencia, Profesional, Especialización/ Maestría, Doctorado.jo Salario a convenir, 4 años de experiencia, Profesional, Especialización/ Maestría, Doctorado</span>...
      </div>
      ...
      <div className='absolute bottom-4 left-6 flex items-center justify-center gap-2'>
        <span className='font-semibold italic'>Postulados:</span>
        <span className='bg-white border border-primary rounded-xl px-3 py-1 text-xl font-bold italic'>100</span>
      </div>
      <div className='absolute bottom-4 right-5 flex items-center justify-center gap-2'>
        <span className='font-semibold italic'>Salario:</span>
        <span className='bg-white border border-primary rounded-xl px-3 py-1 text-xl font-bold italic'>$ 1.000.000</span>
      </div>
    </article>
  )
}
